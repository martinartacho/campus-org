    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white border-2 border-green-500 p-4 rounded-lg shadow-lg text-center hover:shadow-xl hover:border-green-600 transition-all duration-300 cursor-pointer"
            ...
            <div class="mt-2">
                ...
                @if($hasIban)
                    @if($isPdfUpdated)
                        <div class="inline-flex items-center px-2 py-1 rounded-full bg-green-100 text-green-800 border border-green-300 mt-1">
                            <i class="bi bi-check-circle-fill mr-1"></i>
                            <span class="text-xs font-medium">PDF</span>
                        </div>
                    @else
                        <div class="inline-flex items-center px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 border border-yellow-300 mt-1">
                            <i class="bi bi-exclamation-triangle-fill mr-1"></i>
                            <span class="text-xs font-medium">PDF</span>
                        </div>
                    @endif
