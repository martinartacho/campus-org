    ...
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <h4 class="text-lg font-semibold mb-4">UPG</h4>
            ...
            <!-- Enlaces rápidos -->
            <div>
                <h4 class="text-lg font-semibold mb-4">Enllaços</h4>
                <ul class="space-y-2">
                    <li>
            ...
            <!-- Redes sociales -->
            <div>
                <h4 class="text-lg font-semibold mb-4">Seguiu-nos</h4>
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-300 hover:text-white transition-colors" title="Facebook">
                        <i class="bi bi-facebook text-xl"></i>
                    </a>
                    <a href="#" class="text-gray-300 hover:text-white transition-colors" title="Twitter">
                        <i class="bi bi-twitter text-xl"></i>
                    </a>
                    <a href="#" class="text-gray-300 hover:text-white transition-colors" title="LinkedIn">
                        <i class="bi bi-linkedin text-xl"></i>
                    </a>
                    <a href="#" class="text-gray-300 hover:text-white transition-colors" title="Instagram">
                        <i class="bi bi-instagram text-xl"></i>
                    </a>
                    <a href="#" class="text-gray-300 hover:text-white transition-colors" title="YouTube">
                        <i class="bi bi-youtube text-xl"></i>
                    </a>
                </div>
                <div class="mt-4">
                    <p class="text-sm text-gray-400 mb-2">Butlletí informatiu</p>
                    <div class="flex">
                        <input type="email" 
                               placeholder="El teu email" 
                               class="bg-gray-800 text-white px-3 py-2 rounded-l-lg flex-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
