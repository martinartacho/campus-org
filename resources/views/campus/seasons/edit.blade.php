                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="type" name="type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                            ...
                            <option value="annual" {{ old('type', $season->type) == 'annual' ? 'selected' : '' }}>{{ __('campus.annual') }}</option>
                            <option value="semester" {{ old('type', $season->type) == 'semester' ? 'selected' : '' }}>{{ __('campus.semester') }}</option>
                            <option value="trimester" {{ old('type', $season->type) == 'trimester' ? 'selected' : '' }}>{{ __('campus.trimester') }}</option>
                            <option value="quarter" {{ old('type', $season->type) == 'quarter' ? 'selected' : '' }}>{{ __('campus.quarter') }}</option>
                            <option value="bimensual" {{ old('type', $season->type) == 'bimensual' ? 'selected' : '' }}>{{ __('campus.bimensual') }}</option>
                            <option value="monthly" {{ old('type', $season->type) == 'monthly' ? 'selected' : '' }}>{{ __('campus.monthly') }}</option>
                            <option value="custom" {{ old('type', $season->type) == 'custom' ? 'selected' : '' }}>{{ __('campus.custom_period') }}</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="parent_id" name="parent_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            @foreach(\App\Models\CampusSeason::academicYears()->get() as $academicYear)
                                <option value="{{ $academicYear->id }}" {{ old('parent_id', $season->parent_id) == $academicYear->id ? 'selected' : '' }}>
                                    {{ $academicYear->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="registration_start" name="registration_start" type="date" 
                                     class="mt-1 block w-full" 
                                     value="{{ old('registration_start', $season->registration_start?->format('Y-m-d')) }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="registration_end" name="registration_end" type="date" 
                                     class="mt-1 block w-full" 
                                     value="{{ old('registration_end', $season->registration_end?->format('Y-m-d')) }}" />
