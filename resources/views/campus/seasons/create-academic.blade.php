{{-- resources/views/campus/seasons/create-academic.blade.php --}}
@extends('campus.shared.layout')

@section('title', __('campus.create_academic_year'))
@section('subtitle', __('campus.create_academic_year_subtitle'))
...
@section('breadcrumbs')
    ...
    <li aria-current="page">
        <div class="flex items-center">
            <i class="bi bi-chevron-right text-gray-400 mx-1"></i>
            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">{{ __('campus.create_academic_year') }}</span>
        </div>
    </li>
@endsection
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">
                    ...
                    {{ __('campus.create_academic_year') }}
                </h3>
                <p class="mt-1 text-sm text-gray-600">
                    {{ __('campus.create_academic_year_description') }}
                </p>
                <div class="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-md">
                    <p class="text-sm text-blue-800">
                        <i class="bi bi-info-circle me-2"></i>
                        <strong>{{ __('campus.cli_integration_note') }}</strong>
                    </p>
                </div>
            </div>

            <form action="{{ route('campus.seasons.store-academic') }}" method="POST" class="p-6 space-y-6">
                @csrf
