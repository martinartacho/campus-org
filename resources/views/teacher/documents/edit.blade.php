...
<li class="inline-flex items-center">
    <span class="text-gray-400">/</span>
    <span class="ml-1 text-sm font-medium text-gray-500">Editar Document</span>
</li>
@endsection
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                <i class="bi bi-pencil text-green-600 mr-3"></i>
                Editar Document
            </h1>
            <p class="text-gray-600">
                Modifica la informació del teu document
            </p>
        </div>

        <!-- Formulario -->
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('teacher.documents.update', $document) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('description', $document->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="document_type" 
                            ...
                            @foreach($documentTypes as $value => $label)
                                <option value="{{ $value }}" {{ old('document_type', $document->document_type) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                            ...
                            @foreach($visibilityOptions as $value => $label)
                                <label class="flex items-center">
                                    <input type="radio" 
                                           ...
                                           value="{{ $value }}" 
                                           {{ old('student_visibility', $document->student_visibility) == $value ? 'checked' : '' }}
                        ...
                        <p class="mt-2 text-xs text-gray-500">
                            ...
                            Aquesta configuració determina quins estudiants poden veure aquest document
                        </p>
                ...
                <div class="space-y-4">
                    <h3 class="text-lg font-medium text-gray-900 border-b pb-2">Arxiu Actual</h3>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('teacher.documents.download', $document) }}" 
                               class="inline-flex items-center px-3 py-2 text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Deixa aquest camp buit si no vols canviar l'arxiu. Màxim 10MB.
                        </p>
                        @error('file')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t">
                    <a href="{{ route('teacher.documents.show', $document) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
