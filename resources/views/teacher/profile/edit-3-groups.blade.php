            ...
            <form method="POST" action="{{ route('teacher.profile.update') }}" class="space-y-6">
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div id="banking-fields" class="{{ ($teacher->payment_type ?? 'waived') != 'own' ? 'hidden' : '' }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!--                     <div>
                                    <x-input-label for="fiscal_id" :value="__('ID Fiscal')" />
                                    <x-text-input id="fiscal_id" name="fiscal_id" type="text" 
                                            class="mt-1 block w-full" 
                                            value="{{ $teacher->decrypted_fiscal_id ?? $teacher->fiscal_id ?? '' }}" />
                                    <x-input-error class="mt-2" :messages="$errors->get('fiscal_id')" />
                                </div> -->
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">
                                        {{ __('Emissió de Factures') }}
                                    </label>
                                    <div class="mt-2">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <p>{{ __('Les dades bancàries són necessàries només si seleccioneu "Cobrament propi".') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
              ...
              <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                         ...
                         <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mt-6">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <p>{{ __('Si vols cedir el cobrament a una altre persona o entitat, fes servir el camps d\'observacions per indicar: nom complert del beneficiari, NIF, Codi Postal, Dades bancàries i dades contactar-hi.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-6 p-4 border rounded bg-blue-50">
                    <label class="flex items-start">
                        <input type="checkbox" name="data_consent" value="1" 
                            class="mr-2 mt-1" {{ ($teacher->data_consent ?? false) ? 'checked' : '' }}>
                        <span class="text-sm">
                ...
                <div class="bg-yellow-50 p-3 rounded border border-yellow-200">
                    <label class="flex items-start">
                        <input type="checkbox" name="fiscal_responsibility" value="1" 
                            class="mr-2 mt-1" {{ ($teacher->fiscal_responsibility ?? false) ? 'checked' : '' }}>
                        <span class="text-sm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicialitzar - no cal efectes
    console.log('Payment type initialized:', paymentTypeSelect.value);
});
</script>
