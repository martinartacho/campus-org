                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                            Informació personal i de contacte del professor.
                        </p>
                    </div>
        ...
        <div class="md:col-span-1">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        Seleccioneu el tipus de cobrament i completeu les dades corresponents.
                    </p>
                </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-blue-800">
                                    Nota sobre el cobrament
                                </h3>
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Les dades bancàries són necessàries només si seleccioneu "Cobrament propi". Si vols cedir el cobrament, contacta amb comptabilitat.</p>
                                </div>
                            </div>
                        </div>
                    </div>
