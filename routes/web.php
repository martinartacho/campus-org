...
// Test route outside middleware groups
Route::get('/test-public', function() {
    return 'Public route works! Time: ' . date('Y-m-d H:i:s');
});

// Rutas del Catálogo Público de Cursos
...
Route::get('/factura/{registration}', [PublicRegistrationController::class, 'invoice'])->name('registration.invoice');
